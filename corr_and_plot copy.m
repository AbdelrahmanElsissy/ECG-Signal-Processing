function corr_and_plot(fixed_signal,passing_signal,sampling_freq)

% Autocorrelation
[autocorrelation, lags_ac] = xcorr(fixed_signal, fixed_signal);
timeac = lags_ac / sampling_freq;
%Cross Correlation
[correlation, lags] = xcorr(fixed_signal, passing_signal);
